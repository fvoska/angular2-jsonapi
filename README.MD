...
- [x] Setting a specific baseUrl for each model
...
`setBaseEndpoint(baseUrl, apiVersion)` - you can change default `baseUrl` or `apiVersion` after the initialization of datastore.
